            ...
            <div class="container-fluid am-cf">
                <div class="row">
                    <div class="am-u-sm-12 am-u-md-12 am-u-lg-9">
                        <div class="page-header-heading"><span class="am-icon-home page-header-heading-icon"></span> 澳洲留学信息 </div>
                                    ...
                                    <table width="100%" class="am-table am-table-compact am-table-striped tpl-table-black ">
                                        <thead>
                                            <tr>
                                                ...
                                                <th><font color="black">主题</font</th>
                                                <th><font color="black">内容</font</th>
                                                <th><font color="black">详细情况</font</th>
                                                <th><font color="black">编辑</font</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            @foreach ($res as $tt)
                                            <tr class="gradeX">
                                                <td>
                                                    <img src="{{$tt->img}}" class="tpl-table-line-img" alt="" >
                                                </td>                                               
                                                <td class="am-text-middle" >{{$tt->title}}</td>
                                                <td class="am-text-middle" >{{$tt->content}}</td>
                                                <td class="am-text-middle" >{{$tt->more}}</td>
